...
import { AddEmployeeButton, EmployeeActions } from "@/components/bsystems/vault/forms";
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="page-actions">
        <AddEmployeeButton />
        <Link
          href={showInactive ? "/b-systems/vault/employees" : "/b-systems/vault/employees?inactive=true"}
          className="btn-ghost"
